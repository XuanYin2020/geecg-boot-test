<template>
  <div>
    ...
    <a-tabs v-model:activeKey="activeKey" animated  @change="handleChangeTabs">
          <a-tab-pane tab="入职的员工" key="testCompanyEmployee" :forceRender="true">
            <JVxeTable
              keep-source
              resizable
...
<script lang="ts">
  ...
  import {getBpmFormSchema,testCompanyEmployeeColumns} from '../TestCompany.data';
  ...
  export default defineComponent({
    ...
    setup(props){
      ...
      const refKeys = ref(['testCompanyEmployee', ]);
      const activeKey = ref('testCompanyEmployee');
